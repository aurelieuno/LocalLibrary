...
exports.bookinstance_detail = function(req, res, next) {
  ...
  BookInstance.findById(req.params.id)
    .populate('book')//this will replace the book id stored for each BookInstance with a full Book document.
    .exec(function (err, detail_bookinstances) {
      if (err) { return next(err); }
      //Successful, so render
      res.render('bookinstance_detail', { bookinstance_detail: detail_bookinstances });
    });
...
exports.bookinstance_delete_get = function(req, res, next) {
    ...
    .exec(function (err, detail_bookinstances) {
      if (err) { return next(err); }
      //Successful, so render
      res.render('bookinstance_delete', { bookinstance_detail: detail_bookinstances });
    });
